# -*- coding: utf-8 -*-
"""
Created on Mon Feb 13 15:29:49 2023
...
epsilon = 0.03  #Accuracy of the answer
...
while abs(balance) > epsilon:
    ...
    if balance > epsilon: #cath a number to small
        lowerBound = guess
    elif balance < -epsilon: #cath a number to big
        upperBound = guess
    else:
        break
print(round(guess,2))