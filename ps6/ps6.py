...
class Message(object):
    ...
    def build_shift_dict(self, shift):
        ...
        shiftLowerValues = lowerValues[self.shift:] + lowerValues[:self.shift]
       
        upperKeys = list(string.ascii_uppercase)
        upperValues = list(string.ascii_uppercase)
        shiftUpperValues = upperValues[self.shift:] + upperValues[:self.shift]
       
        totalKeys = lowerKeys + upperKeys
        totalValues = shiftLowerValues + shiftUpperValues
        
        shiftedDict = dict(zip(totalKeys, totalValues)) #zip for built a dict
                                                        #with keys and values
                                                        #determinated as shown
    ...
    def apply_shift(self, shift):
        ...
        for i in self.message_text:
            if i not in self.build_shift_dict(shift).keys():
                ...
                newtext.append(self.build_shift_dict(shift)[i])
        return ''.join(newtext)
